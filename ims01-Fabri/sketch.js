...
function preload(){
  // load the shader
  camShader = loadShader('effect.vert', 'effectog.frag');
}
...
function draw() {
  ...
  camShader.setUniform('texelSize', [2.0/width, 2.0/height]); // can play around with the ratio for cool effects like edge blurring (original 1.0 for both)
